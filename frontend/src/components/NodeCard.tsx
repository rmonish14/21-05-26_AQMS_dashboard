...
export default function NodeCard({ data, status, history, variant = 'vertical' }: NodeCardProps) {
  ...
  if (variant === 'horizontal') {
    return (
      <div className={cn(
        "glass-card rounded-xl flex flex-col md:flex-row overflow-hidden transition-shadow duration-200 hover:shadow-md border border-border/50 relative backdrop-blur-md",
        isOffline && "opacity-60"
      )}>
        {/* Left Column: Device Info & Gauges */}
        <div className="flex-1 flex flex-col border-b md:border-b-0 md:border-r border-border p-5 gap-4 min-w-[280px]">
          ...
          <div className="flex-1 flex flex-col justify-center items-center gap-4 py-3 bg-secondary/15 rounded-xl border border-border/30">
            <div className={cn("status-badge px-3 py-1 font-bold", aqiMeta.bg, aqiMeta.border, aqiMeta.color)}>
            ...
            <div className="flex items-center justify-center gap-6">
              <div className="flex flex-col items-center gap-2">
                <GaugeWidget
                  ...
                  label="Temp" unit="°C"
                  colorClass="stroke-orange-400" size={70}
                />
              </div>
              <div className="flex flex-col items-center gap-2">
                <GaugeWidget
                  ...
                  label="Humid" unit="%"
                  colorClass="stroke-blue-400" size={70}
                />
              </div>
            </div>
          </div>
        ...
        {/* Middle Column: Primary Air Quality Metrics */}
        <div className="flex-[1.2] flex flex-col border-b md:border-b-0 md:border-r border-border p-5 gap-3 justify-center min-w-[280px]">
          <p className="text-[9px] font-black uppercase tracking-widest text-muted-foreground mb-1">Telemetry Metrics</p>
        ...
        {/* Right Column: Trend & Relay Control */}
        <div className="flex-[1.3] flex flex-col p-5 gap-4 justify-between min-w-[320px]">
          <div className="space-y-2">
            ...
            <div className="h-[90px] w-full opacity-90 hover:opacity-100 transition-opacity">
              <LiveChart
                data={history}
                dataKey="aqi"
        ...
        {showShare && (
          <div className="absolute inset-0 bg-background/80 backdrop-blur-sm z-50 flex items-center justify-center p-4">
            <div className="bg-card w-full max-w-sm border border-border rounded-xl shadow-lg flex flex-col overflow-hidden animate-in zoom-in-95 duration-200">
